...
<head>
    ...
    <title>Contact Us || DevFlex</title>
    <!-- favicon -->
...
<body>
	...
	<div class="aboutheading">
		<h1>Connect to me.</h1>
		<p>Drop a line through form given below and we'll get you soon.</p>
	</div>
	...
	<footer>
		<div id="header-group">
			<div class="comapanyname">
				<h1>&copy; Recived 2024 DevFlex.com </h1>
			</div>
			<div class="developeby">
				<h1>Develope By :- <a href="#">DevFlex.com</a></h1>
			</div>
		</div>
	</footer>
